...
import (
	...
	coreclient "k8s.io/kubeadm/pkg/client/clientset_generated/internalclientset/typed/core/internalversion"
	internalinformers "k8s.io/kubeadm/pkg/client/informers/informers_generated/internalversion"
	kubeoptions "k8s.io/kubeadm/pkg/kubeapiserver/options"
	kubeletclient "k8s.io/kubeadm/pkg/kubelet/client"
	"k8s.io/kubeadm/pkg/master/reconcilers"
	"k8s.io/kubeadm/pkg/master/tunneler"
	endpointsstorage "k8s.io/kubeadm/pkg/registry/core/endpoint/storage"
	"k8s.io/kubeadm/pkg/routes"
	"k8s.io/kubeadm/pkg/serviceaccount"
	...
	admissionregistrationrest "k8s.io/kubeadm/pkg/registry/admissionregistration/rest"
	appsrest "k8s.io/kubeadm/pkg/registry/apps/rest"
	authenticationrest "k8s.io/kubeadm/pkg/registry/authentication/rest"
	authorizationrest "k8s.io/kubeadm/pkg/registry/authorization/rest"
	autoscalingrest "k8s.io/kubeadm/pkg/registry/autoscaling/rest"
	batchrest "k8s.io/kubeadm/pkg/registry/batch/rest"
	certificatesrest "k8s.io/kubeadm/pkg/registry/certificates/rest"
	coordinationrest "k8s.io/kubeadm/pkg/registry/coordination/rest"
	corerest "k8s.io/kubeadm/pkg/registry/core/rest"
	eventsrest "k8s.io/kubeadm/pkg/registry/events/rest"
	extensionsrest "k8s.io/kubeadm/pkg/registry/extensions/rest"
	networkingrest "k8s.io/kubeadm/pkg/registry/networking/rest"
	policyrest "k8s.io/kubeadm/pkg/registry/policy/rest"
	rbacrest "k8s.io/kubeadm/pkg/registry/rbac/rest"
	schedulingrest "k8s.io/kubeadm/pkg/registry/scheduling/rest"
	settingsrest "k8s.io/kubeadm/pkg/registry/settings/rest"
	storagerest "k8s.io/kubeadm/pkg/registry/storage/rest"
)
...
func (c completedConfig) New(delegationTarget genericapiserver.DelegationTarget) (*Master, error) {
	...
	// This priority order is used for local discovery, but it ends up aggregated in `k8s.io/kubeadm/cmd/kube-apiserver/app/aggregator.go
