...
import (
	...
	admissionregistration "k8s.io/kubeadm/pkg/apis/admissionregistration"
	apps "k8s.io/kubeadm/pkg/apis/apps"
	autoscaling "k8s.io/kubeadm/pkg/apis/autoscaling"
	batch "k8s.io/kubeadm/pkg/apis/batch"
	certificates "k8s.io/kubeadm/pkg/apis/certificates"
	coordination "k8s.io/kubeadm/pkg/apis/coordination"
	...
	rbac "k8s.io/kubeadm/pkg/apis/rbac"
	scheduling "k8s.io/kubeadm/pkg/apis/scheduling"
	settings "k8s.io/kubeadm/pkg/apis/settings"
	storage "k8s.io/kubeadm/pkg/apis/storage"
)
