...
import (
	...
	"k8s.io/kubeadm/pkg/kubectl"
	"k8s.io/kubeadm/pkg/kubectl/cmd/templates"
	cmdutil "k8s.io/kubeadm/pkg/kubectl/cmd/util"
	"k8s.io/kubeadm/pkg/kubectl/cmd/util/openapi"
	"k8s.io/kubeadm/pkg/kubectl/genericclioptions"
	"k8s.io/kubeadm/pkg/kubectl/genericclioptions/printers"
	"k8s.io/kubeadm/pkg/kubectl/genericclioptions/resource"
	"k8s.io/kubeadm/pkg/kubectl/scheme"
	"k8s.io/kubeadm/pkg/kubectl/util/i18n"
	"k8s.io/kubeadm/pkg/kubectl/validation"
)
