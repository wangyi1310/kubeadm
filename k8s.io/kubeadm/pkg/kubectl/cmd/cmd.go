...
import (
	...
	"k8s.io/kubeadm/pkg/kubectl/cmd/auth"
	cmdconfig "k8s.io/kubeadm/pkg/kubectl/cmd/config"
	"k8s.io/kubeadm/pkg/kubectl/cmd/create"
	"k8s.io/kubeadm/pkg/kubectl/cmd/get"
	"k8s.io/kubeadm/pkg/kubectl/cmd/rollout"
	"k8s.io/kubeadm/pkg/kubectl/cmd/set"
	"k8s.io/kubeadm/pkg/kubectl/cmd/templates"
	cmdutil "k8s.io/kubeadm/pkg/kubectl/cmd/util"
	"k8s.io/kubeadm/pkg/kubectl/cmd/wait"
