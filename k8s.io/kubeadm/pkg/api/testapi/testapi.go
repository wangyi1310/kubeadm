...
import (
	...
	"k8s.io/kubeadm/pkg/apis/admission"
	"k8s.io/kubeadm/pkg/apis/admissionregistration"
	"k8s.io/kubeadm/pkg/apis/apps"
	"k8s.io/kubeadm/pkg/apis/authorization"
	"k8s.io/kubeadm/pkg/apis/autoscaling"
	"k8s.io/kubeadm/pkg/apis/batch"
	"k8s.io/kubeadm/pkg/apis/certificates"
	"k8s.io/kubeadm/pkg/apis/coordination"
	api "k8s.io/kubeadm/pkg/apis/core"
	"k8s.io/kubeadm/pkg/apis/events"
	"k8s.io/kubeadm/pkg/apis/extensions"
	"k8s.io/kubeadm/pkg/apis/imagepolicy"
	"k8s.io/kubeadm/pkg/apis/networking"
	"k8s.io/kubeadm/pkg/apis/policy"
	"k8s.io/kubeadm/pkg/apis/rbac"
	"k8s.io/kubeadm/pkg/apis/scheduling"
	"k8s.io/kubeadm/pkg/apis/settings"
	"k8s.io/kubeadm/pkg/apis/storage"

	_ "k8s.io/kubeadm/pkg/apis/admission/install"
	_ "k8s.io/kubeadm/pkg/apis/admissionregistration/install"
	_ "k8s.io/kubeadm/pkg/apis/apps/install"
	_ "k8s.io/kubeadm/pkg/apis/authentication/install"
	_ "k8s.io/kubeadm/pkg/apis/authorization/install"
	_ "k8s.io/kubeadm/pkg/apis/autoscaling/install"
	_ "k8s.io/kubeadm/pkg/apis/batch/install"
	_ "k8s.io/kubeadm/pkg/apis/certificates/install"
	_ "k8s.io/kubeadm/pkg/apis/coordination/install"
	_ "k8s.io/kubeadm/pkg/apis/core/install"
	_ "k8s.io/kubeadm/pkg/apis/events/install"
	_ "k8s.io/kubeadm/pkg/apis/extensions/install"
	_ "k8s.io/kubeadm/pkg/apis/imagepolicy/install"
	_ "k8s.io/kubeadm/pkg/apis/networking/install"
	_ "k8s.io/kubeadm/pkg/apis/policy/install"
	_ "k8s.io/kubeadm/pkg/apis/rbac/install"
	_ "k8s.io/kubeadm/pkg/apis/scheduling/install"
	_ "k8s.io/kubeadm/pkg/apis/settings/install"
	_ "k8s.io/kubeadm/pkg/apis/storage/install"
)
