...
// Generated code, generated via: `mockgen k8s.io/kubeadm/pkg/kubelet/network NetworkPlugin > $GOPATH/src/k8s.io/kubeadm/pkg/kubelet/network/testing/mock_network_plugin.go`
...
import (
	...
	container "k8s.io/kubeadm/pkg/kubelet/container"
