...
import (
	...
	registerapi "k8s.io/kubeadm/pkg/kubelet/apis/pluginregistration/v1alpha1"
	v1beta1 "k8s.io/kubeadm/pkg/kubelet/util/pluginwatcher/example_plugin_apis/v1beta1"
	v1beta2 "k8s.io/kubeadm/pkg/kubelet/util/pluginwatcher/example_plugin_apis/v1beta2"
)
