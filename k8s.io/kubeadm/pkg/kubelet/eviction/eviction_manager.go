...
import (
	...
	apiv1resource "k8s.io/kubeadm/pkg/api/v1/resource"
	...
	statsapi "k8s.io/kubeadm/pkg/kubelet/apis/stats/v1alpha1"
	evictionapi "k8s.io/kubeadm/pkg/kubelet/eviction/api"
	...
	kubelettypes "k8s.io/kubeadm/pkg/kubelet/types"
