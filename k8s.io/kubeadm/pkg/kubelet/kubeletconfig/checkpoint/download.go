...
import (
	...
	"k8s.io/kubeadm/pkg/kubelet/apis/kubeletconfig/scheme"
	kubeletconfigv1beta1 "k8s.io/kubeadm/pkg/kubelet/apis/kubeletconfig/v1beta1"
	"k8s.io/kubeadm/pkg/kubelet/kubeletconfig/status"
	utilcodec "k8s.io/kubeadm/pkg/kubelet/kubeletconfig/util/codec"
	utillog "k8s.io/kubeadm/pkg/kubelet/kubeletconfig/util/log"
)
...
func DecodeRemoteConfigSource(data []byte) (RemoteConfigSource, error) {
	...
	if !ok {
		return nil, fmt.Errorf("failed to cast decoded remote config source to *k8s.io/kubeadm/pkg/kubelet/apis/kubeletconfig.SerializedNodeConfigSource")
	}
