...
import (
	...
	"k8s.io/kubeadm/pkg/kubelet/checkpointmanager/checksum"
	utilstore "k8s.io/kubeadm/pkg/kubelet/checkpointmanager/testing"
	"k8s.io/kubeadm/pkg/kubelet/checkpointmanager/testing/example_checkpoint_formats/v1"
)
