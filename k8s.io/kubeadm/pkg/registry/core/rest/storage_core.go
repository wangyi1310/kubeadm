...
import (
	...
	"k8s.io/kubeadm/pkg/api/legacyscheme"
	api "k8s.io/kubeadm/pkg/apis/core"
	policyclient "k8s.io/kubeadm/pkg/client/clientset_generated/internalclientset/typed/policy/internalversion"
	"k8s.io/kubeadm/pkg/features"
	kubeletclient "k8s.io/kubeadm/pkg/kubelet/client"
	"k8s.io/kubeadm/pkg/master/ports"
	"k8s.io/kubeadm/pkg/registry/core/componentstatus"
	configmapstore "k8s.io/kubeadm/pkg/registry/core/configmap/storage"
	endpointsstore "k8s.io/kubeadm/pkg/registry/core/endpoint/storage"
	eventstore "k8s.io/kubeadm/pkg/registry/core/event/storage"
	limitrangestore "k8s.io/kubeadm/pkg/registry/core/limitrange/storage"
	namespacestore "k8s.io/kubeadm/pkg/registry/core/namespace/storage"
	nodestore "k8s.io/kubeadm/pkg/registry/core/node/storage"
	pvstore "k8s.io/kubeadm/pkg/registry/core/persistentvolume/storage"
	pvcstore "k8s.io/kubeadm/pkg/registry/core/persistentvolumeclaim/storage"
	podstore "k8s.io/kubeadm/pkg/registry/core/pod/storage"
	podtemplatestore "k8s.io/kubeadm/pkg/registry/core/podtemplate/storage"
	"k8s.io/kubeadm/pkg/registry/core/rangeallocation"
	controllerstore "k8s.io/kubeadm/pkg/registry/core/replicationcontroller/storage"
	resourcequotastore "k8s.io/kubeadm/pkg/registry/core/resourcequota/storage"
	secretstore "k8s.io/kubeadm/pkg/registry/core/secret/storage"
	"k8s.io/kubeadm/pkg/registry/core/service/allocator"
	serviceallocator "k8s.io/kubeadm/pkg/registry/core/service/allocator/storage"
	"k8s.io/kubeadm/pkg/registry/core/service/ipallocator"
	"k8s.io/kubeadm/pkg/registry/core/service/portallocator"
	servicestore "k8s.io/kubeadm/pkg/registry/core/service/storage"
	serviceaccountstore "k8s.io/kubeadm/pkg/registry/core/serviceaccount/storage"
