...
import (
	...
	schedulingapiv1alpha1 "k8s.io/kubeadm/pkg/apis/scheduling/v1alpha1"
	schedulingapiv1beta1 "k8s.io/kubeadm/pkg/apis/scheduling/v1beta1"
	schedulingclient "k8s.io/kubeadm/pkg/client/clientset_generated/internalclientset/typed/scheduling/internalversion"
	priorityclassstore "k8s.io/kubeadm/pkg/registry/scheduling/priorityclass/storage"
)
