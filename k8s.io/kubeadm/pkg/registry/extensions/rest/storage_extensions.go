...
import (
	...
	daemonstore "k8s.io/kubeadm/pkg/registry/apps/daemonset/storage"
	deploymentstore "k8s.io/kubeadm/pkg/registry/apps/deployment/storage"
	replicasetstore "k8s.io/kubeadm/pkg/registry/apps/replicaset/storage"
	expcontrollerstore "k8s.io/kubeadm/pkg/registry/extensions/controller/storage"
	ingressstore "k8s.io/kubeadm/pkg/registry/extensions/ingress/storage"
	networkpolicystore "k8s.io/kubeadm/pkg/registry/networking/networkpolicy/storage"
	pspstore "k8s.io/kubeadm/pkg/registry/policy/podsecuritypolicy/storage"
)
