...
import (
	...
	"k8s.io/kubeadm/pkg/registry/rbac/clusterrole"
	clusterrolepolicybased "k8s.io/kubeadm/pkg/registry/rbac/clusterrole/policybased"
	clusterrolestore "k8s.io/kubeadm/pkg/registry/rbac/clusterrole/storage"
	"k8s.io/kubeadm/pkg/registry/rbac/clusterrolebinding"
	clusterrolebindingpolicybased "k8s.io/kubeadm/pkg/registry/rbac/clusterrolebinding/policybased"
	clusterrolebindingstore "k8s.io/kubeadm/pkg/registry/rbac/clusterrolebinding/storage"
	"k8s.io/kubeadm/pkg/registry/rbac/reconciliation"
	"k8s.io/kubeadm/pkg/registry/rbac/role"
	rolepolicybased "k8s.io/kubeadm/pkg/registry/rbac/role/policybased"
	rolestore "k8s.io/kubeadm/pkg/registry/rbac/role/storage"
	"k8s.io/kubeadm/pkg/registry/rbac/rolebinding"
	rolebindingpolicybased "k8s.io/kubeadm/pkg/registry/rbac/rolebinding/policybased"
	rolebindingstore "k8s.io/kubeadm/pkg/registry/rbac/rolebinding/storage"
	rbacregistryvalidation "k8s.io/kubeadm/pkg/registry/rbac/validation"
	"k8s.io/kubeadm/plugin/pkg/auth/authorizer/rbac/bootstrappolicy"
)
...
func (p RESTStorageProvider) NewRESTStorage(apiResourceConfigSource serverstorage.APIResourceConfigSource, restOptionsGetter generic.RESTOptionsGetter) (genericapiserver.APIGroupInfo, bool) {
	...
	// If you add a version here, be sure to add an entry in `k8s.io/kubeadm/cmd/kube-apiserver/app/aggregator.go with specific priorities.
