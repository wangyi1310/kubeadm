...
import (
	...
	appsv1beta1 "k8s.io/kubeadm/pkg/apis/apps/v1beta1"
	appsv1beta2 "k8s.io/kubeadm/pkg/apis/apps/v1beta2"
	"k8s.io/kubeadm/pkg/apis/autoscaling"
	autoscalingv1 "k8s.io/kubeadm/pkg/apis/autoscaling/v1"
	autoscalingvalidation "k8s.io/kubeadm/pkg/apis/autoscaling/validation"
	"k8s.io/kubeadm/pkg/apis/extensions"
	extensionsv1beta1 "k8s.io/kubeadm/pkg/apis/extensions/v1beta1"
	extvalidation "k8s.io/kubeadm/pkg/apis/extensions/validation"
	...
	"k8s.io/kubeadm/pkg/registry/apps/deployment"
)
