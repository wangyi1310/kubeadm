...
import (
	...
	controllerrevisionsstore "k8s.io/kubeadm/pkg/registry/apps/controllerrevision/storage"
	daemonsetstore "k8s.io/kubeadm/pkg/registry/apps/daemonset/storage"
	...
	statefulsetstore "k8s.io/kubeadm/pkg/registry/apps/statefulset/storage"
)
