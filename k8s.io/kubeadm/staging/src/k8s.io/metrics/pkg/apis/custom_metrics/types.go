...
// NOTE: ObjectReference is copied from k8s.io/kubeadm/pkg/api/types.go. We
// cannot depend on k8s.io/kubeadm/pkg/api because that creates cyclic
// dependency between k8s.io/metrics and k8s.io/kubeadm. We cannot depend on
