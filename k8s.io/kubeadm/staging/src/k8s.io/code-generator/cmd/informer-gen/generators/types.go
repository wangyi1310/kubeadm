...
var (
	apiScheme                   = types.Name{Package: "k8s.io/kubeadm/pkg/api/legacyscheme", Name: "Scheme"}
	...
	listOptions                 = types.Name{Package: "k8s.io/kubeadm/pkg/apis/core", Name: "ListOptions"}
