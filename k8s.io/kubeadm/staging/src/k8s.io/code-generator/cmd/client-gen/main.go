...
func main() {
	...
	genericArgs.OutputPackagePath = "k8s.io/kubeadm/pkg/client/clientset_generated/"

	genericArgs.AddFlags(pflag.CommandLine)
	customArgs.AddFlags(pflag.CommandLine, "k8s.io/kubeadm/pkg/apis") // TODO: move this input path out of client-gen
