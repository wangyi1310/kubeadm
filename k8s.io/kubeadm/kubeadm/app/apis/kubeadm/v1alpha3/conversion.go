...
import (
	...
	kubeletconfigscheme "k8s.io/kubeadm/pkg/kubelet/apis/kubeletconfig/scheme"
	kubeletconfigv1beta1 "k8s.io/kubeadm/pkg/kubelet/apis/kubeletconfig/v1beta1"
	"k8s.io/kubeadm/pkg/proxy/apis/kubeproxyconfig"
	kubeproxyconfigscheme "k8s.io/kubeadm/pkg/proxy/apis/kubeproxyconfig/scheme"
	kubeproxyconfigv1alpha1 "k8s.io/kubeadm/pkg/proxy/apis/kubeproxyconfig/v1alpha1"
)
