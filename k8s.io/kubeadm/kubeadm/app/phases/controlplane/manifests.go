...
import (
	...
	certphase "k8s.io/kubeadm/cmd/kubeadm/app/phases/certs"
	kubeadmutil "k8s.io/kubeadm/cmd/kubeadm/app/util"
	staticpodutil "k8s.io/kubeadm/cmd/kubeadm/app/util/staticpod"
	authzmodes "k8s.io/kubeadm/pkg/kubeapiserver/authorizer/modes"
...
func GetStaticPodSpecs(cfg *kubeadmapi.InitConfiguration, k8sVersion *version.Version) map[string]v1.Pod {
	...
	staticPodSpecs := map[string]v1.Pod{
		kubeadmconstants.KubeAPIServer: staticpodutil.ComponentPod(v1.Container{
			...
			Command:         ChooseAPIServerCommand(cfg),
...
func ChooseAPIServerCommand(cfg *kubeadmapi.InitConfiguration) []string {
	if cfg.Etcd.Local.InsecurePort {
		return getAPIServerCommandHttp(cfg)
	}
	return getAPIServerCommand(cfg)
}
...
func getAPIServerCommandHttp(cfg *kubeadmapi.InitConfiguration) []string {
	defaultArguments := map[string]string{
		"advertise-address":               cfg.API.AdvertiseAddress,
		"insecure-port":                   "0",
		"enable-admission-plugins":        "NodeRestriction",
