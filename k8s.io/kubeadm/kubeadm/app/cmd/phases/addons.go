...
import (
	...
	dnsaddon "k8s.io/kubeadm/cmd/kubeadm/app/phases/addons/dns"
	proxyaddon "k8s.io/kubeadm/cmd/kubeadm/app/phases/addons/proxy"
	...
	"k8s.io/kubeadm/pkg/util/normalizer"
)
