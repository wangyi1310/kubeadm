...
import (
	...
	kubeadmscheme "k8s.io/kubeadm/cmd/kubeadm/app/apis/kubeadm/scheme"
	kubeadmapiv1alpha3 "k8s.io/kubeadm/cmd/kubeadm/app/apis/kubeadm/v1alpha3"
	"k8s.io/kubeadm/cmd/kubeadm/app/apis/kubeadm/validation"
	kubeadmconstants "k8s.io/kubeadm/cmd/kubeadm/app/constants"
	"k8s.io/kubeadm/cmd/kubeadm/app/discovery"
	"k8s.io/kubeadm/cmd/kubeadm/app/features"
	certsphase "k8s.io/kubeadm/cmd/kubeadm/app/phases/certs"
	controlplanephase "k8s.io/kubeadm/cmd/kubeadm/app/phases/controlplane"
	kubeconfigphase "k8s.io/kubeadm/cmd/kubeadm/app/phases/kubeconfig"
	kubeletphase "k8s.io/kubeadm/cmd/kubeadm/app/phases/kubelet"
	markmasterphase "k8s.io/kubeadm/cmd/kubeadm/app/phases/markmaster"
	patchnodephase "k8s.io/kubeadm/cmd/kubeadm/app/phases/patchnode"
	"k8s.io/kubeadm/cmd/kubeadm/app/preflight"
	kubeadmutil "k8s.io/kubeadm/cmd/kubeadm/app/util"
	"k8s.io/kubeadm/cmd/kubeadm/app/util/apiclient"
	configutil "k8s.io/kubeadm/cmd/kubeadm/app/util/config"
	kubeconfigutil "k8s.io/kubeadm/cmd/kubeadm/app/util/kubeconfig"
